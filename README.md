...
To fully utilize this theme, you should install the companion JavaScript module from [this repository](https://github.com/Nerwyn/ha-material-color-utilities). In addition to installing it using HACS, you must add it to your `configuration.yaml` as described in its README.
